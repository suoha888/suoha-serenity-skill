...
```text
Use suoha-serenity-skill to deeply research [market] [theme].
...
```text
用 suoha-serenity-skill 深度调研现在 A 股 [行业/主题]。
...
```text
用 suoha-serenity-skill 研究港股 [主题]。
...
```text
Use suoha-serenity-skill to research US-listed [theme] companies.
...
```text
用 suoha-serenity-skill 陪我讨论 [主题/公司]。
